    ...
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-4rem)] p-6 bg-gradient-to-br from-kmg-50 to-white text-center">
      <div className="bg-white p-8 md:p-12 rounded-3xl shadow-xl max-w-3xl w-full border border-gray-100 transform transition-all hover:scale-[1.01]">
        <div className="mb-8 flex justify-center sm:justify-end">
          <button
            onClick={() => onStart()}
            className="w-full sm:w-auto px-10 py-4 bg-kmg-600 text-white text-xl md:text-2xl font-bold rounded-2xl hover:bg-kmg-700 active:bg-kmg-800 transition-all shadow-lg hover:shadow-xl hover:-translate-y-1 focus:outline-none focus:ring-4 focus:ring-kmg-500 focus:ring-opacity-50"
          >
            {t.welcome.startBtn}
          </button>
        </div>
